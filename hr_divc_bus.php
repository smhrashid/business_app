...
?>
  ...
  <table class="table">
	...
	while($row4=oci_fetch_array($collection_info_stid))
                                            ...
                                            <td><div align="left"><?php echo $row4[10]; $nb_sum+=$row4[10];?></div></td> 
                                            <td><div align="left"><?php echo $row4[12]; $d_sum+=$row4[12];?></div></td>
                                            <td><div align="left"><?php echo $row4[13]; $s0_sum+=$row4[13];?></div></td>
                                            <td><div align="left"><?php echo $row4[14]; $s6_sum+=$row4[14];?></div></td> 
                                            
                                            <td><div align="left"><?php echo $row4[15]; $ts_sum+=$row4[15];?></div></td> 
                                            <td><div align="left"><?php echo $row4[16]; $tc_sum+=$row4[16];?></div></td>
                                            <td><div align="left"><?php echo $row4[11]; $tg_sum+=$row4[11];?></div></td>
                                            <td><div align="left"><?php echo $row4[17]; $rp_sum+=$row4[17];?></div></td>
                                            <td><div align="left"><?php echo $row4[18]; $to_sum+=$row4[18];?></div></td> 
                                            </tr>
                                            <?php  } ?> 
                                            <tr>
                                            <td></td>
                                            ...
                                            <td><div align="left"><strong><?php echo $d_sum;?></strong></div></td>
